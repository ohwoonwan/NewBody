...
public class Home_Training_side_lateral_raise1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountView = findViewById(R.id.CountView18);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_side_lateral_raise1.this, Home_Training_Rest6.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_side_lateral_raise1.this,Home_Training_Rest7.class);
