...
public class Home_Training_Rest6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_rest6);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button13);
        ...
        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton13);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Rest6.this, Home_Training_Shoulder_Press2.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Rest6.this, Home_Training_side_lateral_raise1.class);
