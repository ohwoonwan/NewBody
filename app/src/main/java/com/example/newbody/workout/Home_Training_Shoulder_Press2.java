...
public class Home_Training_Shoulder_Press2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_shoulder_press2);

        Intent intentV = new Intent(this, VoiceRecognitionService.class);
        startService(intentV);

        CountView = findViewById(R.id.CountView12);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button12);
        ...
        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton12);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Shoulder_Press2.this, Home_Training_Rest5.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Shoulder_Press2.this, Home_Training_Rest6.class);
