...
public class Home_Training_Pushup1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_pushup1);

        Intent intentV = new Intent(this, VoiceRecognitionService.class);
        startService(intentV);

        CountView = findViewById(R.id.CountView6);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button6);
        ...
        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton6);
...
// 타이머 자동 실행
    ...
    private void startTimer() {
        ...
        switch (selectedDifficulty) {
            case "쉬움":
                timerDuration = 18 * 1000; // 분*초*1000
                CountView.setText("주어진 시간 동안 7개를 성공 시키세요!");
                break;
            case "보통":
                ...
                break;
            case "어려움":
                timerDuration = 56 * 1000; // 분*초*1000
                CountView.setText("주어진 시간 동안 35개를 성공 시키세요!");
                break;
            default:
                timerDuration = 18 * 1000;
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Pushup1.this, Home_Training_Rest2.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Pushup1.this, Home_Training_Rest3.class);
