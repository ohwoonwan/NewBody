...
public class Home_Training_Rest8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_rest8);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button17);
        ...
        // 다음 액티비티로 이동하는 버튼
        nextButton = findViewById(R.id.next_button17);
        ...
        // 타이머 텍스트뷰
        timerTextView = findViewById(R.id.timerTextView17);

        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton17);
