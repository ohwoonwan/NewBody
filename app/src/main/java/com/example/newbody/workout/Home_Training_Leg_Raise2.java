...
public class Home_Training_Leg_Raise2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_leg_raise2);

        Intent intentV = new Intent(this, VoiceRecognitionService.class);
        startService(intentV);

        CountView = findViewById(R.id.CountView16);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button16);
        ...
        // 다음 액티비티로 이동하는 버튼
        nextButton = findViewById(R.id.next_button16);
        ...
        // 타이머 텍스트뷰
        timerTextView = findViewById(R.id.timerTextView16);

        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton16);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Leg_Raise2.this, Home_Training_Rest7.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Leg_Raise2.this, Home_Training_Rest8.class);
