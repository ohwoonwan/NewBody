...
public class Home_Training_Rest9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_rest9);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button19);
        ...
        // 다음 액티비티로 이동하는 버튼
        nextButton = findViewById(R.id.next_button19);
        ...
        // 타이머 텍스트뷰
        timerTextView = findViewById(R.id.timerTextView19);

        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton19);
...
// 타이머 자동 실행
    ...
    private void startTimer() {
        ...
        switch (selectedDifficulty) {
            case "쉬움":
                timerDuration = 10 * 1000; // 분*초*1000
                break;
            case "보통":
                timerDuration = 10 * 1000; // 분*초*1000
                break;
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Rest9.this, Home_Training_side_lateral_raise1.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Rest9.this, Home_Training_side_lateral_raise2.class);
