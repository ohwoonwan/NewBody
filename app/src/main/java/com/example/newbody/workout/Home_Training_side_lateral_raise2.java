...
public class Home_Training_side_lateral_raise2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_side_lateral_raise2);

        Intent intentV = new Intent(this, VoiceRecognitionService.class);
        startService(intentV);

        CountView = findViewById(R.id.CountView20);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button20);
        ...
        // 다음 액티비티로 이동하는 버튼
        nextButton = findViewById(R.id.next_button20);
        ...
        // 타이머 텍스트뷰
        timerTextView = findViewById(R.id.timerTextView20);

        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton20);
...
// 타이머 자동 실행
    ...
    private void startTimer() {
        ...
        switch (selectedDifficulty) {
            case "쉬움":
                ...
                break;
            case "보통":
                timerDuration = 68 * 1000; // 분*초*1000
                CountView.setText("주어진 시간 동안 25개를 성공 시키세요!");
                break;
            case "어려움":
                timerDuration = 73 * 1000; // 분*초*1000
                CountView.setText("주어진 시간 동안 35개를 성공 시키세요!");
                break;
            default:
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_side_lateral_raise2.this, Home_Training_Rest9.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_side_lateral_raise2.this,Home_Training_Rest8.class);
