...
public class Home_Training_Leg_Raise1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button14);
        ...
        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton14);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Leg_Raise1.this, Home_Training_Rest6.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Leg_Raise1.this, Home_Training_Rest7.class);
