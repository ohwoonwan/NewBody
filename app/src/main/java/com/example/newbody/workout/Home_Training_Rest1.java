...
public class Home_Training_Rest1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_rest1);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button3);
        ...
        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton3);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Rest1.this, Home_Training_Squat1.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Rest1.this, Home_Training_Squat2.class);
