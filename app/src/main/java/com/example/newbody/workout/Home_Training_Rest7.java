...
public class Home_Training_Rest7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_rest7);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button15);
        ...
        // 다음 액티비티로 이동하는 버튼
        nextButton = findViewById(R.id.next_button15);
        ...
        // 타이머 텍스트뷰
        timerTextView = findViewById(R.id.timerTextView15);

        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton15);
...
// 타이머 자동 실행
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Rest7.this, Home_Training_side_lateral_raise1.class);
