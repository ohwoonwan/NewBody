...
public class Home_Training_WarmUp extends AppCompatActivity {
    ...
    private VoiceTask voiceTask;  // VoiceTask의 인스턴스 선언
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prevButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onBackPressed(); // 현재 액티비티 종료하여 이전 액티비티로 돌아감
            }
        });
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                moveToSubActivity2(); // SubActivity2로 이동
            }
        });
...
// 타이머 자동 실행
    ...
    private void startTimer() {
        ...
        switch (selectedDifficulty) {
            case "쉬움":
                timerDuration = 5 * 60 * 1000; // 분*초*1000
                break;
            case "보통":
                timerDuration = 5 * 60 * 1000; // 분*초*1000
                break;
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_WarmUp.this, Video.class);
    ...
    private void moveToSubActivity2() {

        // 액티비티 넘어가면 종료되면 타이머도 함께 종료
        if (timer != null) {
            timer.cancel();
        }
        Intent intentSub2 = new Intent(Home_Training_WarmUp.this, Home_Training_Squat1      .class);
        intentSub2.putExtra("difficulty", selectedDifficulty); // 선택된 난이도를 SubActivity2로 전달
