...
public class Home_Training_Shoulder_Press1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_training_shoulder_press1);

        Intent intentV = new Intent(this, VoiceRecognitionService.class);
        startService(intentV);

        CountView = findViewById(R.id.CountView10);
        ...
        // 이전 액티비티로 이동하는 버튼
        prevButton = findViewById(R.id.prev_button10);
        ...
        // 타이머 버튼
        timerButton = findViewById(R.id.startbutton10);
...
// 타이머 자동 실행
    ...
    private void startTimer() {
        ...
        switch (selectedDifficulty) {
            case "쉬움":
                timerDuration = 27 * 1000; // 분*초*1000
                CountView.setText("주어진 시간 동안 10개를 성공 시키세요!");
                break;
            case "보통":
                timerDuration = 25 * 1000; // 분*초*1000
                CountView.setText("주어진 시간 동안 10개를 성공 시키세요!");
                break;
            case "어려움":
                timerDuration = 25 * 1000; // 분*초*1000
                ...
                break;
            default:
                timerDuration = 27 * 1000; // 기본값은 30초로 설정
        }
    ...
    public void onBackPressed() {
        ...
        Intent prevIntent = new Intent(Home_Training_Shoulder_Press1.this, Home_Training_Rest4.class);
    ...
    private void moveToHome_Training_Squaut1() {
        ...
        Intent intentSub2 = new Intent(Home_Training_Shoulder_Press1.this, Home_Training_Rest5.class);
