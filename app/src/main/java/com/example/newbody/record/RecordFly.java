...
public class RecordFly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_fly);

        Intent intentS = new Intent(this, VoiceRecognitionService.class);
        startService(intentS);

        prev = findViewById(R.id.prevButtonDumbbellFly);
        timeInput = findViewById(R.id.timeInput);

        start = findViewById(R.id.startDumbbellFly);
        Intent intent = getIntent();
        time = intent.getLongExtra("time", 0);

        timeInput.setText((time / 60000) + "분");

        mVideoView = findViewById(R.id.dumbbellFlyEx);
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/raw/dumbbellfly");
        ...
        start.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RecordFly.this, RecordFlyMain.class);
